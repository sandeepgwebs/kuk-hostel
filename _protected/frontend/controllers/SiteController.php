...
//------------------------------------------------------------------------------------------------//
	...
	public function actionMyform(){
		...
		if ($model->load(Yii::$app->request->post()) && $model->validate())
		{
			...
			return $this->render('formentry', ['model' => $model]);
		}
	}
    ...
    public function actionProspectus()
    {
        return $this->render('prospectus');
    }
    ...
    public function actionAdmission_lists()
    {
        return $this->render('admission_lists');
    }
